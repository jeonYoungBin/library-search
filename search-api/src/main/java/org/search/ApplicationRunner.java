...
public class ApplicationRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        DailyStat stat10 = new DailyStat("data", LocalDateTime.now());

        DailyStat stat11 = new DailyStat("os", LocalDateTime.now());

        dailyStatRepository.saveAll(List.of(stat1, stat2, stat3, stat4, stat5, stat6, stat7, stat8, stat9, stat10, stat11));
    }
}
